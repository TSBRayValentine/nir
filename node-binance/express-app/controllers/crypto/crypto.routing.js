...
const getDataForMainNode = require("./controllers/getDataForMainNode.action");
...
// -------------------------------------------------------
// Отправка данных на главный узел

router.get("/getDataForMainNode", getDataForMainNode.action);
